...
void bleRequestData()
{
    ...
    // connected we set the conneted flag to be true.
    if (doConnect == true)
    {
        if (connectToServer())
        {
